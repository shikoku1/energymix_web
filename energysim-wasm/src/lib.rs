...
pub fn get_sliders_json() -> String {
    let sliders = vec![
        SliderConfig {
            name_human: "☀️ Fotovoltaico installato all'anno, inizio [GW]".to_string(),
        ...
        SliderConfig {
            name_human: "☀️ Fotovoltaico installato all'anno, fine [GW]".to_string(),
        ...
        SliderConfig {
            name_human: "💨 Eolico installato all'anno, inizio [GW]".to_string(),
        ...
        SliderConfig {
            name_human: "💨 Eolico installato all'anno, fine [GW]".to_string(),
        ...
        SliderConfig {
            name_human: "☢️ Nucleare installato all'anno, inizio [GW]".to_string(),
        ...
        SliderConfig {
            name_human: "☢️ Nucleare installato all'anno, fine [GW]".to_string(),
        ...
        SliderConfig {
            name_human: "☢️🕐 Durata Cantiere Nucleare (foak) [anni]".to_string(),
        ...
        SliderConfig {
            name_human: "☢️🕐 Durata Cantiere Nucleare (noak) [anni]".to_string(),
        ...
        SliderConfig {
            name_human: "💦♻️🌋 Produzione altre fonti low-carbon [TWh]".to_string(),
